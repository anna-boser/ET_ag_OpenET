...
ggplot(bardata, aes(x = month)) +
  ...
  scale_color_manual(
    values = c("ag_ET" = "#009966", "ET_pred" = "darkgoldenrod", "ET" = "black"),
...
ggplot(bardata, aes(x = month)) +
  ...
  scale_x_continuous(breaks = c(1, 4, 7, 10)) +
  scale_color_manual(
    values = c("ag_ET" = "#009966", "ET_pred" = "darkgoldenrod", "ET" = "black", "Pcp" = "grey"),
    breaks = c("ag_ET", "ET_pred", "ET", "Pcp"),
    labels = c("Agricultural ET", "Natural ET", "Total ET", "Precipitation"),
    name = ""
  ) +
  scale_fill_manual(
    values = c("ag_ET" = "#009966", "ET_pred" = "darkgoldenrod", "ET" = "black", "Pcp" = "white"),
    breaks = c("ag_ET", "ET_pred", "ET", "Pcp"),
    labels = c("Agricultural ET", "Natural ET", "Total ET", "Precipitation"),
    name = ""
  ) +
