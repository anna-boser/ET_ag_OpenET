...
1. Processing already existing data into datasets usable for the study (`1_generate_datasets`) (R)
1. Creating the artificial counterfactual estimating natural ET (`2_counterfactual`) (Python)
1. Doing analysis (R, Rmd)
