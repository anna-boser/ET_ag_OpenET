...
ggplot(data_year) +
  ...
  theme(axis.text.x = element_text(size = 5),
        ...
        legend.text = element_text(size = 5), # Set legend text size to 7pt
        legend.title = element_text(size = 7),# Set legend title size to 7pt
        axis.title.x = element_text(size = 6), # Set x-axis title size to 7pt
...
ggplot(ts, aes(x = month)) + 
  ...
  theme(legend.position = "top", 
    ...
    legend.title = element_text(size = 7),# Set legend title size to 7pt
    axis.title.x = element_text(size = 6), # Set x-axis title size to 7pt
    axis.title.y = element_text(size = 6)) # move legend to the top to allow more space for the plot
