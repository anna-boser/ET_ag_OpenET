...
filter(bardata, type == "ag_ET", cropnames != "Young Perennial") %>% 
  ...
  scale_fill_manual(values=c(ag_ET="seagreen", ET_pred="goldenrod4"), breaks=c("ag_ET","ET_pred"), labels = c("Agricultural ET", "Naturally-occurring ET")) + 
  ...
  geom_linerange(aes(ymax = min, ymin = max), size=1.1, color = "seagreen") + 
  ylab("cm/year") + 
  theme_classic() + 
  labs(fill='') + 
  # ylim(c(-35, 165)) + 
